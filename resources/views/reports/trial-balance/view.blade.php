...
@section('content')
    <div class="container-fluid mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('reports.trial.balance.report') }}" method="GET" target="_blank">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="as_of_date" name="as_of_date"
                                    placeholder="DD-MM-YYYY" value="{{ $request->as_of_date ?? now()->format('d-m-Y') }}">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="project_id" name="project_id[]"
                                    ...
                                    @forelse($projects as $project)
                                        <option value="{{ $project->id }}" @selected(in_array($project->id, (array) ($request->project_id ?? [])))>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('reports.trial.balance.view') }}"
                                class="btn btn-secondary">@lang('messages.reset')</a>
                        </div>
                    </div>
                </form>
            </div>
