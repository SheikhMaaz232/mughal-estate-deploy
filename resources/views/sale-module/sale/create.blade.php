...
@section('content')
    <div class="block block-rounded col-md-12">
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('messages.add-sale-invoice')</h3>
        </div>
        <div class="block-content block-content-full">
            <form id="sale-invoice-form" action="{{ route('sale-invoice.store') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="sale_invoice_no" class="form-label">@lang('messages.sale_invoice_no')</label>
                ...
                {{-- <div class="row justify-content-end">
                    <div class="col-md-6 mb-3">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" id="shipping" name="carriage" value="{{ old('carriage') }}"
                ...
                <div class="row justify-content-end">
                    <div class="col-md-6 mb-3">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="net-amount" style="color: black; background-color: #e9ecef !important;"
                                    class="form-control {{ config('constants.css-classes.ELEMENT_SIZE_CLASS') }} net-amount"
                                    name="net_amount" placeholder="@lang('messages.net_amount')" value="{{ old('net_amount') }}"
                                    readonly>
                            </div>
                        </div>
                    </div>
