...
@section('content')
    <div class="block block-rounded col-md-12">
        <div class="block-header block-header-default">
            <h3 class="block-title">@lang('messages.edit-purchase-invoice')</h3>
        </div>
        <div class="block-content block-content-full">
            <form id="purchase-invoice-form" action="{{ route('purchase-invoice.update', $purchaseMaster->id) }}"
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" value="{{ $purchaseMaster->id }}" disabled>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" style="background-color: #e9ecef !important;" name="grn_no"
                            value="{{ $purchaseMaster->grn_no }}" readonly>
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" style="background-color: #e9ecef !important;" name="purchase_order_no"
                            value="{{ $purchaseMaster->purchase_order_no }}" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="date"
                            value="{{ old('date', isset($purchaseMaster->date) ? $purchaseMaster->date : now()->format('Y-m-d')) }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="hidden" name="project_id" value="{{ $purchaseMaster->project_id }}">
                        @error('project_id')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="hidden" name="party_id" value="{{ $purchaseMaster->party_id }}">
                        @error('party_id')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="hidden" name="detail_account_id" value="{{ $purchaseMaster->detail_account_id }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" style="background-color: #e9ecef !important;" class="form-control"
                            ...
                            value="{{ old('supplier_bill_no', $purchaseMaster->supplier_bill_no) }}" readonly>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" style="background-color: #e9ecef !important;" class="form-control"
                            ...
                            value="{{ old('unloaded_by', $purchaseMaster->unloaded_by) }}" readonly>
                        @error('unloaded_by')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea type="text" class="form-control" id="remarks" name="remarks" placeholder="@lang('messages.remarks')"
                            autocomplete="off">{{ old('remarks', $purchaseMaster->remarks) }}</textarea>
                        @error('remarks')
                            <div class="text-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                                    ...
                                    @if (!empty($purchaseDetails))
                                        @foreach ($purchaseDetails as $purchaseDetail)
                                            ...
                                            <tr>
                                                    ...
                                                    <select id="product_id"
                                                        ...
                                                        @foreach ($items as $productData)
                                                            <option value="{{ $productData->id }}"
                                                                {{ (old('product_id') ?? $purchaseDetail->product_id) == $productData->id ? 'selected' : '' }}>
                                                ...
                                                <td class="quantity">
                                                    <input type="text"
                                                        style="color: black; background-color: #e9ecef !important; "
                                                ...
                                                <td class="price">
                                                    <input type="number" name="price[]"
                                                        value="{{ $purchaseDetail->price }}" step="any"
                                                ...
                                                <td class="detail_remarks">
                                                    <textarea name="detail_remarks[]"
                                                        ...
                                                        placeholder="@lang('messages.remarks')" rows="2">{{ $purchaseDetail->detail_remarks }}</textarea>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" id="carriage"
                                    ...
                                    value="{{ old('carriage', $purchaseMaster->carriage) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" id="tax"
                                    ...
                                    value="{{ old('tax', $purchaseMaster->tax) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" id="other_amount"
                                    ...
                                    value="{{ old('other_amount', $purchaseMaster->other_amount) }}"
